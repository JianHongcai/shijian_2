...
public class SendEmailUtil {
    ...
    public static boolean sendMail(String to, String emailMsg) {
        ...
        try {
            ...
            String emailUser ="169703623@qq.com"; //(String) context.lookup("java:comp/env/emailUser");
            String emailPwd ="ykefaeaxpesebjac";// (String) context.lookup("java:comp/env/emailPwd");
